Finished a program to take a regular expression and convert it to HDL that can be loaded onto an FPGA.  Now going to beging studying FPGA documentation to learn
